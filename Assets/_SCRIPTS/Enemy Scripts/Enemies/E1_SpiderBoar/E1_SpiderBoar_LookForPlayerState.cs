...
public class E1_SpiderBoar_LookForPlayerState : Enemy_LookForPlayerState
{
    ...
    public E1_SpiderBoar_LookForPlayerState(EnemyBase _enemyBase, EnemyFiniteStateMachine _enemyStateMachine, string _enemyAnimationBoolName, D_EnemyData _enemyData, E1_SpiderBoar enemySpiderBoar) : base(_enemyBase, _enemyStateMachine, _enemyAnimationBoolName, _enemyData)
    {
